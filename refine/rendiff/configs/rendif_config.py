CONFIG = {
    ...
    'camera_names': ['camera1', 'camera2', 'camera3', 'camera4', 'camera5', 'wrist'],
    ...
    'num_iters': 200001,  # Number of iterations to train for.
    'num_diffusion_iters_train': 50,  # Number of diffusion iterations during training.
    ...
    'save_itt': [1000, 3000, 5000, 8000, 10000, 20000, 30000, 50000, 100000, 150000, 200000],  # Iterations to save the model at.
